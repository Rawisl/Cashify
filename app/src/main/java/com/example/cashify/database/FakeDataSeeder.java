...
public class FakeDataSeeder {
    public static void seed(Context context) {
        ...
        if (true) {
            ...
            cal.set(2026, Calendar.APRIL, 1, 9, 0, 0); // từ 9h sáng ngày 01/03
            ...
            dao.insert(makeTransaction(20000, 0, 4, "Bánh mì dân tổ", getMillis(cal, 1)));
            dao.insert(makeTransaction(55000, 0, 4, "Bún đậu mắm tôm", getMillis(cal, 1)));
            dao.insert(makeTransaction(30000, 0, 8, "Cafe muối chú Long", getMillis(cal, 1)));
            dao.insert(makeTransaction(45000, 0, 4, "Phở bò tái lăn", getMillis(cal, 1)));
            dao.insert(makeTransaction(60000, 0, 4, "Pizza Hut khuyến mãi", getMillis(cal, 1)));
            ...
            try {
                ...
                Log.e("BACKEND_TEST", "Lỗi: " + e.getMessage());
            }
        }
    }
